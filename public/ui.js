...
export function mountShell() {
  ...
  for(const [buttonId,panelId] of [['accountToggle','accountMenu'],['mobileToggle','mobileMenu']]){
    ...
    root.addEventListener('focusout',e=>{if(!panel.hidden&&!panel.contains(e.relatedTarget)&&e.relatedTarget!==button)close();});
